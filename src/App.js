...
//Please note, I haven't actually really learned much about react (4 years off raising kids). This project has been bootstrapped using create-react-app to begin. I wrote this in vanilla JS and have attempted to use react. I am sure there is a lot that I can change and I will do so once I learn more about it. Either way, tadaaaaaa. 
...
class Wheel extends Component {
    ...
    componentDidMount(){
        ...
        //mouseDown
		    el.onmousedown = (function(e) {mousedown()})
            el.ontouchstart = (function(e) {mousedown()})
        //MouseUp
            el.onmouseup = (function(e) {mouseup()})
            el.ontouchend= (function(e) {mouseup()})
        ...
        function mouseup(){
          ...
          try {         
            ...
            setTimeout(function() {
                ans.innerHTML = answerArray;
            }, 1000);


            answerArray = answerArray.filter(function(n){ return n !== 0 }); 
            ...
            prediction = arrWind.sort(function(a, b) {
                return arrWind.filter(function(v) {
                    return v === a
                }).length - arrWind.filter(function(v) {
                    return v === b
                }).length
            }).pop()
            ...
            var accuracyTotal = accuracy.reduce(function(a, b) {return a + b;})
    ...
    render(){
        return (
            <div className="intro">
                ...
                <p>If on desktop, click the wheel to spin it. Hold down your click for as long or as short as you want for different spin speed</p>
                <p>On mobile, spin the wheel by doing using your finger to drag it (don't tap, swipe)</p>
            </div>
        )
    }
}
